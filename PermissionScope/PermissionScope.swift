...
@objc public class PermissionScope: UIViewController, CLLocationManagerDelegate, UIGestureRecognizerDelegate, CBPeripheralManagerDelegate {
    ...
    func permissionStyledButton(_ type: PermissionType) -> UIButton {
        ...
        button.addTarget(self, action: #selector(manageSelector(_:)), for: .touchUpInside)
    ...
    @objc func manageSelector(_ button: UIButton) {
        ...
        case "permissionscope.button.contacts":
            requestContacts()
        case "permissionscope.button.events":
            requestEvents()
        case "permissionscope.button.locationalways":
            requestLocationAlways()
        case "permissionscope.button.locationinuse":
            requestLocationInUse()
        case "permissionscope.button.notifications":
            requestNotifications()
        case "permissionscope.button.microphone":
            requestMicrophone()
        case "permissionscope.button.camera":
            requestCamera()
        case "permissionscope.button.photos":
            requestPhotos()
        case "permissionscope.button.reminders":
            requestReminders()
        case "permissionscope.button.bluetooth":
            requestBluetooth()
        case "permissionscope.button.motion":
            requestMotion()
        default:
            break
        }
